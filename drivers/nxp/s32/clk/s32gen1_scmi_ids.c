...
struct s32gen1_scmi_clk cc_scmi_clk[] = {
	...
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_TMU_MODULE,
			 S32GEN1_CLK_XBAR_DIV3, "tmu_module"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_TMU_REG,
			 S32GEN1_CLK_XBAR_DIV3, "tmu_reg"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_FR_REG,
			 S32GEN1_CLK_XBAR_DIV3, "flexray_reg"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_FR_PE,
			 S32GEN1_CLK_FLEXRAY_PE, "flexray_pe"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_WKPU_MODULE,
			 S32GEN1_CLK_XBAR_DIV6, "wkpu_module"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_WKPU_REG,
			 S32GEN1_CLK_XBAR_DIV6, "wkpu_reg"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_SRC_MODULE,
			 S32GEN1_CLK_XBAR_DIV6, "src_module"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_SRC_REG,
			 S32GEN1_CLK_XBAR_DIV6, "src_reg"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_SRC_TOP_MODULE,
			 S32GEN1_CLK_XBAR_DIV6, "src_top_module"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_SRC_TOP_REG,
			 S32GEN1_CLK_XBAR_DIV6, "src_top_reg"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_CTU_MODULE,
			 S32GEN1_CLK_XBAR_DIV3, "ctu_module"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_CTU_CTU,
			 S32GEN1_CLK_PER, "ctu_ctu"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_DBG_SYS4,
	...
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_M7_CORE,
			 S32GEN1_CLK_XBAR, "m7"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_DMAMUX_MODULE,
			 S32GEN1_CLK_XBAR_DIV3, "dmamux_module"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_DMAMUX_REG,
			 S32GEN1_CLK_XBAR_DIV3, "dmamux_reg"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_GIC_MODULE,
			 S32GEN1_CLK_A53_CORE_DIV2, "gic_module"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_MSCM_MODULE,
	...
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_XRDC_MODULE,
			 S32GEN1_CLK_XBAR_DIV6, "xrdc_module"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_XRDC_REG,
			 S32GEN1_CLK_XBAR_DIV6, "xrdc_reg"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_CLKOUT_0,
			 S32GEN1_CLK_CLKOUT0, "clkout0"),
	SCMI_ARRAY_ENTRY(S32GEN1_SCMI_CLK_CLKOUT_1,
